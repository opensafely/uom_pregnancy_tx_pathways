...
#| fig-cap: "Figure 1. Overall trend of code usage of 'pregnancy_antenatal_snomed' codelist from 1st August 2011 to 31 July 2022. Each point represents the end date of a yearly interval." 
#| fig-width: 8
#| fig-height: 4
...
#| fig-cap: "Figure 2. Trends of the 10 most used codes of 'pregnancy_antenatal_snomed' codelist from 1st August 2011 to 31 July 2022. Each point represents the end date of a yearly interval." 
#| fig-width: 8
#| fig-height: 4
...
#| fig-cap: "Figure 1. Overall trend of code usage of 'pregnancy_delivery_snomed_reviewed_2' codelist from 1st August 2011 to 31 July 2022. Each point represents the end date of a yearly interval." 
#| fig-width: 8
#| fig-height: 4
...
#| fig-cap: "Figure 1. Overall trend of code usage of 'pregnancy_postdel_antenatal_snomed' codelist from 1st August 2011 to 31 July 2022. Each point represents the end date of a yearly interval." 
#| fig-width: 8
#| fig-height: 4
...
selected_snomed_code_usage |>
  ...
  group_by(snomed_concept_id) |>
  mutate(
    usage_code_yearly_pct = usage / usage_codelist_sum_yearly,
    usage_code_max_yearly_pct = max(usage_code_yearly_pct, na.rm = TRUE),
  ...
  mutate(
    crit_yearly_volume = usage_code_max_yearly_pct > .05,
    crit_yearly_change = usage_code_max_change_yearly_pct > .1,
    crit_startend_change = usage_code_max_change_yearly_pct > .3
    ) |>
  filter((crit_yearly_volume & crit_yearly_change) | (crit_yearly_volume & crit_startend_change)) |>
  select(-c(active_at_start, active_at_end)) |>
  print(n = 20)
```
