...
setwd(here::here("output", "updated_pn6wk"))
...
bltab_vars <- df_overall3 %>% select(patient_id, age, age_cat, bmi, bmi_cat, delivery_code_number, region, ethnicity, ethnicity2,  imd, pn8wk_code_number, postnatal_8wk_code_present, charlsonGrp, covid_positive) 
bltab_vars_before  <- df_before3 %>% select(patient_id, age, age_cat, bmi, bmi_cat, delivery_code_number, region, ethnicity, ethnicity2, imd, pn8wk_code_number, postnatal_8wk_code_present, charlsonGrp,covid_positive) 
bltab_vars_after  <- df_after3 %>% select(patient_id, age, age_cat, bmi, bmi_cat, delivery_code_number, region, ethnicity, ethnicity2, imd, pn8wk_code_number, postnatal_8wk_code_present, charlsonGrp, covid_positive) 
...
#str(t)
#write_csv(t, here::here("output", "blt_overall_6wk.csv"))
write_csv(t, here::here("output", "blt_overall_6wk_update.csv"))

bltab_vars_before %>% summary_factorlist(explanatory = colsfortab_before) -> t2
#str(t2)
#write_csv(t2, here::here("output", "blt_before_6wk.csv"))
write_csv(t2, here::here("output", "blt_before_6wk_update.csv"))


bltab_vars_after %>% summary_factorlist(explanatory = colsfortab_after) -> t3
#str(t3)
#write_csv(t3, here::here("output", "blt_after_6wk.csv"))
write_csv(t3, here::here("output", "blt_after_6wk_update.csv"))
...
#write_csv(overall_counts, here::here("output", "overall_counts_6wk.csv"))
...
#write_csv(overall_counts_before, here::here("output", "overall_counts_before_6wk.csv"))
write_csv(overall_counts_before, here::here("output", "overall_counts_before_6wk_update.csv"))
...
#write_csv(overall_counts_after, here::here("output", "overall_counts_after_6wk.csv"))
write_csv(overall_counts_after, here::here("output", "overall_counts_after_6wk_update.csv"))
