...
bltab_vars_before  <- df_before3 %>% select(patient_id, age, age_cat, bmi, bmi_cat, delivery_code_number, region, ethnicity, imd, pn8wk_code_number, postnatal_8wk_code_present, charlsonGrp,covid_positive) 
bltab_vars_after  <- df_after3 %>% select(patient_id, age, age_cat, bmi, bmi_cat, delivery_code_number, region, ethnicity, imd, pn8wk_code_number, postnatal_8wk_code_present, charlsonGrp, covid_positive) 
