...
## table delivery codes. 
table_del_codes <- as.data.frame(table(df$delivery_code)) 
...
df_3<-merge(table_del_codes, df_1, by="code")
...
df_3<-df_3[,-2]
write_csv(df_3, here::here("output","delivery_codes_count.csv"))
