...
#  short model  
## traditional glm()
model_full <- glm(postnatal_8wk_code_present ~ hbp_pregnancy, data = df_input, family = binomial(link = "logit"))
...
write_csv(fit_results, here::here("output","mod_hbp_only.csv"))
