...
df <- read_rds('basic_joined_8wk_records_2020.rds')
...
write_csv(tabdelcodes, here::here("output", "table_delcodes_8wk_update_2020.csv"))
rm(tabdelcodes)
...
tabdelcodes <- as.data.frame(table(df$delivery_code_present))
write_csv(tabdelcodes, here::here("output", "table_delcodes_8wk_update_2020_after_numeric.csv"))
rm(tabdelcodes)

df <- df %>% dplyr::filter(delivery_code_present > 1)
tabdelcodes <- as.data.frame(table(df$delivery_code_present))
write_csv(tabdelcodes, here::here("output", "table_delcodes_8wk_update_2020_after_filter.csv"))
rm(tabdelcodes)
...
write_csv(overall_counts, here::here("output", "overall_counts_8wk_update_2020.csv"))
...
t<-(t[-1,])
write_csv(t, here::here("output", "blt_overall_8wk_update_2020.csv"))
