...
df <- read_rds('cohort_selection_one_random_obvs_6wk.rds')
...
overall_counts$cohort<- "6 weeks"
overall_counts$withPN <- round(sum(df$postnatal_8wk_code_present)/5)*5
write_csv(overall_counts, here::here("output", "overall_counts_6wk_cohort_one_obs.csv"))
...
t<-(t[-1,])
write_csv(t, here::here("output", "blt_overall_6wk_cohort_one_obs_contin.csv"))
...
write_csv(t2, here::here("output", "blt_overall_6wk_cohort_one_obs_cat.csv"))
write_csv(data2, here::here("output", "blt_overall_6wk_cohort_one_obs_cat_rounded.csv"))