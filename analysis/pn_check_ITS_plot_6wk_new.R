...
write_csv(as.data.frame(df_plot_copy), here::here("output", "ITS_plot_data_overall_rates_and_predicted_6wk.csv"))
rm(df_plot_copy)
...
write_csv(as.data.frame(df_plot_counter_final_copy), here::here("output", "ITS_plot_data_overall_rates_and_predicted_counterfact_6wk.csv"))
...
ggsave(
   ...
   filename="pn_check_ITS_overall_6wk_new_modelled_updated.jpeg", path=here::here("output"),
)