...
fit_results <- tidy(model_agebmiethimd, exponentiate = TRUE)

# Extract confidence intervals and exponentiate them
conf_intervals <- confint(model_agebmiethimd)
...
write_csv(fit_results, here::here("output","mod_agebmiethimd.csv"))
