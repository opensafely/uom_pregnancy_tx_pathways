...
# import data
df <- read_csv(
  here::here("output", "joined_6wk", "measure_postnatal_check_rate_by_practice.csv"),
  col_types = cols_only(
...
ggsave(
  ...
  filename="monthly_pn_rate_measures8wkcode_by_practice_6wk.jpeg", path=here::here("output"),
)
